...
At this point we performed an unconstrained geometry optimisation at the CAM-B3LYP/6-311G* + D3(BJ) level of theory which yielded the \textit{cis}-isomers seen in figure~\ref{fig:Conformers}.
%
%
...
To further characterize the molecules we calculated their lowest lying singlet excited states and visualized their ntos as well as their molecular orbitals, which are shown in the appendix.
...
\begin{figure}[H]
  ...
  %
  %
  \caption{Detachment (red) and attachment (blue) densities at an isovalue of 0.02 for the energetically three lowest excited singlet states S1 to S3 of tAB-1c-tolane-crest-rot9 at the CAM-B3LYP/6-311G* level of theory}
  ...
  \end{subfigure}
  %
  \caption{Detachment (red) and attachment (blue) densities at an isovalue of 0.02 for the  excited singlet states S4 to S6 of tAB-1c-tolane-crest-rot9 at the CAM-B3LYP/6-311G* level of theory}
  \label{fig:att-det:tAB-1c-tolane-crest-rot9}
  \end{figure}
%
%
...
\begin{figure}[H]
  ...
  %
  %
  \caption{Detachment (red) and attachment (blue) densities at an isovalue of 0.02 for the energetically lowest three excited singlet states S1 to S3 of cAB-1c-tolane at the CAM-B3LYP/6-311G* level of theory.}
  ...
  \end{subfigure}
  %
  \caption{Detachment (red) and attachment (blue) densities at an isovalue of 0.02 for the excited singlet states S4 to S6 of cAB-1c-tolane at the CAM-B3LYP/6-311G* level of theory.}
  \label{fig:att-det:cAB-1c-tolane-crest-rot9}
  \end{figure}
...
%
The difference in energy between S2 and S3 is pronounced (INSERT VALUE) at a small CNNC dihedral angle, but narrows as the angle increases. 
...
From the optimized structure calculations in \ref{abs:iso_process} the MO energies were extracted.
%
...
\\
To summarize a change in the CNNC dihedral angle affects the energy of the n(AB\_1) HOMO and $\pi^*$ LUMO the most, leading to a respective energetic maximum and minimum at \SI[]{80}{\degree}.
...
%It appears that
polar solvents seems to lower the molecular entropy for the flat molecule, but not for tAB-3c-tolane-rot3, which could be due to tAB-3c-tolane-rot3 possessing less surface area than tAB-3c-tolane-flat and thus having a smaller area which can interact with the solvent. \\
%
%thermodynamics
%
\begin{comment}
