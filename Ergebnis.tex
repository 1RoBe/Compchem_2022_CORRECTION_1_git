...
To further characterize the molecules we calculated their lowest lying singlet excited states and visualized their ntos as well as their molecular orbitals.
...
The gap between both MOs decreases from \SI{6.69}{\eV} for the cAB-1c-tolane-tor to \SI{3.95}{\eV} at at a torsional angle of \SI{100}{\degree}. 
%
%
%
%
...
$\pi^*$(tol) possesses a higher energy in the \textit{trans}-configuration than in \textit{cis}-configuration.
One possible explanation could be the reduced overlap of the orbitals located at the tolane unit, due to an increase of the \ce{Ph-C\bond{#}C-Ph} dihedral angle of tolane from \SI{3}{\degree} in cis configuration to \SI{21}{\degree} in trans configuration. 
% 
...
tAB-3c-tolane-flat possesses an even lower value for the Gibbs free energy in toluene compared to tAB-3c-tolane in DCM,  the difference between the other solvents is greater (6.4 $\frac{\SI{}{\kilo\joule}}{\SI{}{\mole}}$).
% 
