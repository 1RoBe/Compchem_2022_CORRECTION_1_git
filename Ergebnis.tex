...
The first objective of this project was to select a functional and basis set which worked well across \textit{cis}-AB, \textit{trans}-AB and tolane which are the components of the molecules we are interested in. 
To accomplish this task the first two excited states of each molecule were computed by the methods listed in figure \ref{fig:cAB_Benchmark}-\ref{fig:tolan_Benchmark} and compared to their respective experimental values gathered by the analysis of the UV-Spectra of the compounds. \newline
