...
$\pi^*$(tol) possesses a higher energy in the \textit{configuration} than in \textit{configuration}.
...
For tAB-3c-tolane-flat, the smallest value for the Gibbs free energy occurs in toluene with a respective deviation of ~6.5 $\frac{\SI{}{\kilo\joule}}{\SI{}{\mole}}$ between the other solvents.\\ 
