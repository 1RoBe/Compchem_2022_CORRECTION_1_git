...
the first 20 excited states of each molecule at the CAM-B3LYP/6-311G* level of theory with the D3(BJ) dispersion correction. The resulting states were fitted with a Lorentzian function resulting in UV-spectra \ref{fig:uv_fig_cAB}-\ref{fig:uv_fig_tolane}. 
%
%
\begin{figure}[H]
    \centering
...
\end{subfigure}
%
\caption{Detachment (red) and attachment (blue) densities for the energetically lowest five excited singlet states S1 to S5 of cAB at the CAM-B3LYP/\\6-311G* level of theory with an isovalue of 0.02.}
\label{fig:nto_cab}
\end{figure}
\vspace{1 cm}
%
