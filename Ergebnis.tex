...
\\
The second singlet excited state (S2) resembles a $\pi\pi^*$ charge-transfer transition, since its detachment densities are localized on the tolane substructure,
while its attachment densities are localized on the AB unit. 
