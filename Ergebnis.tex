...
$\pi^*$(tol) possesses a higher energy in the trans configuration than cis configuration.
One possible explanation could be the reduced overlap of the $\pi*$ orbitals located at the tolane unit, due to an increase of the \ce{Ph-C\bond{#}C-Ph} dihedral angle of tolane from \SI{3}{\degree} in cis configuration to \SI{21}{\degree} in trans configuration. 
% 
...
$\pi^*$(AB) decreases in energy with an increasing CNNC dihedral angle until it reaches its minimum at \SI{80}{\degree}, at which point it increases in energy again until a CNNC dihedral angle of \SI{179}{\degree} is reached.  \\
